...
export function CommandPalette() {
  ...
  const commands: Cmd[] = useMemo(() => {
    ...
    const actions: Cmd[] = [
      ...
      { id: 'game', label: c.game, hint: '🎮', group: 'action', keywords: 'juego game jugar atrapa catch tito minijuego play arcade', icon: Gamepad2, run: () => { window.dispatchEvent(new Event('game:open')); close() } },
